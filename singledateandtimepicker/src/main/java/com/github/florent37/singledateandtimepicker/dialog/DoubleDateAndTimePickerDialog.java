...
//        Log.d("layout", Integer.toString(layout));
        this.bottomSheetHelper = new BottomSheetHelper(context, layout);           // 시트지 모양
    ...
    private void init(View view) {
        ...
        final TextView buttonOk = (TextView) view.findViewById(R.id.okbttn);
        if (buttonOk != null) {
...
//        pickerTab1.setTimeZone(timeZone);
    ...
    public static class Builder {
        ...
        private boolean bottomSheet;        // 확인 버튼이 필요한가 부분
