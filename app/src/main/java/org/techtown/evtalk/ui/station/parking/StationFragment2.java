...
public class StationFragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView t5 = v.findViewById(R.id.textView45);
        TextView t6 = v.findViewById(R.id.textView46);
        TextView t7 = v.findViewById(R.id.textView47);
        TextView t8 = v.findViewById(R.id.textView48);
        TextView t9 = v.findViewById(R.id.textView49);
        ...
        if(StationPageActivity.station.get(StationFragment1.parsingcount).getParkingFree().equals("NULL"))
            t6.setText("정보없음");
        else {
            if(StationPageActivity.station.get(StationFragment1.parsingcount).getParkingFree().equals("Y"))
                t6.setText("있음");
            else if(StationPageActivity.station.get(StationFragment1.parsingcount).getParkingFree().equals("N"))
                t6.setText("없음");
            else
                t6.setText(StationPageActivity.station.get(StationFragment1.parsingcount).getParkingFree());
        }
        ...
        if(StationPageActivity.station.get(StationFragment1.parsingcount).getLimitYn().equals("NULL"))
            t8.setText("정보없음");
        else {
            if(StationPageActivity.station.get(StationFragment1.parsingcount).getLimitYn().equals("Y"))
                t8.setText("있음");
            else if(StationPageActivity.station.get(StationFragment1.parsingcount).getLimitYn().equals("N"))
                t8.setText("없음");
            else
                t8.setText(StationPageActivity.station.get(StationFragment1.parsingcount).getLimitYn());
        }
