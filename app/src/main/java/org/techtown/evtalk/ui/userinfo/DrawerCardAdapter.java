...
public class DrawerCardAdapter extends RecyclerView.Adapter<DrawerCardAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.cardlayout_small, viewGroup, false);
